...
class Actuators {
	...
	public:
		...
		Actuators(){
			joint_history_pos_.setZero()
			joint_history_vel_.setZero()
		};

		void initHandlersAndGroup(bool & ActuatorConnected)
		{
		...
		void sendCommand(Eigen::Vector3d pTarget3){
		...
		Eigen::VectorXd getFeedback(){
			...
			motor_pos << m1_pos_fbk, m2_pos_fbk, d1;
			...
			motor_vel << m1_vel_fbk, m2_vel_fbk, d2;
